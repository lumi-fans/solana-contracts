...
- The program in this repository (`lumi`) as deployed on the cluster named on the Lumi Contracts page, which shows the deployed hash and the commit it was built from.
